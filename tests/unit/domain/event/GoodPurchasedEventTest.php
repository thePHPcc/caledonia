...
#[CoversClass(GoodPurchasedEvent::class)]
#[UsesClass(Price::class)]
#[UsesClass(Uuid::class)]
#[Group('domain')]
#[Small]
final class GoodPurchasedEventTest extends TestCase
{
    ...
    {
        $this->assertSame('market.good-purchased', $this->event()->topic());
    }
    ...
    {
        $this->assertSame('1 bread purchased at price 1', $this->event()->asString());
    }

    private function event(): GoodPurchasedEvent
    {
